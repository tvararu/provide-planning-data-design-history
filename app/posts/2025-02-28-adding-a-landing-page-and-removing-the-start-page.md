---
title: Adding a landing page and removing the start page
description: |-
  The problem
...
screenshots:
  items:
  - text: Check start page
    src: 01-check-start-page.png
    alt: The start page for the check planning and housing data service
  - text: Landing page
    src: 02-landing-page.png
    alt: The new landing page for the submit and update your planning data service
tags: []
---
