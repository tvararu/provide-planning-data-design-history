---
title: Giving users feedback on their datasets
description: |-
  The problem
...
screenshots:
  items:
  - text: Feedback Prototype — Org dashboard
    src: 01-feedback-prototype-org-dashboard.png
    alt: The organisation dashboard from the original feedback prototype designed
      by Paul Smith
  - text: Feedback Prototype — Improve data tasklist
    src: 02-feedback-prototype-improve-data-tasklist.png
    alt: The tasklist page from the original feedback prototype developed by Paul
      Smith
  - text: Feedback MVP flow
    src: 03-feedback-mvp-flow.png
    alt: First iteration of the feedback tool user flow
  - text: LPA dashboard flow
    src: 04-lpa-dashboard-flow.png
    alt: The second iteration of the feedback flow showing how the dashboard is a
      launching point for the different tools LPAs need to use
tags: []
---
...
We [held a workshop](https://app.mural.co/t/mhclg2837/m/mhclg2837/1712672338705/0c710f39b40b0dd05e91b2648535f6a474695a14) with the data management team to explore ideas on how to develop this further to meet user needs.
